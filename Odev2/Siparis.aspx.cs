...
namespace Odev2
{
    public partial class Siparis : System.Web.UI.Page
    {
        ...
        public void KullaniciGetir()
        {
            SqlDataAdapter da = new SqlDataAdapter("Select * from Kullanici",
                @"server = OSMANSIVRIKAYA; Database = c2cProje; Integrated Security = True");
    ...
    {
        public SqlConnection con = new SqlConnection("server=OSMANSIVRIKAYA;Database=c2cProje;Integrated Security=True");
